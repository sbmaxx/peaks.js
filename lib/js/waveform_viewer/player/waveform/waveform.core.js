...
define([
  ...
  ], function (bootstrap, WaveformData, WaveformOverview, WaveformZoomView, WaveformSegments, WaveformSpeakerSegments) {
  ...
  return function () {
    return {
      ...
      getInformationData: function(options) {
        this.options = options;
        var xhr, that = this;
        ...
        var handleJSONObject = function (jsonObject) {
          that.jsonObject = jsonObject;

          that.speaker_segments = new WaveformSpeakerSegments(that, that.jsonObject, that.options);
