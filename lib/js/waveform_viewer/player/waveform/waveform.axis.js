 ...
 */ 
 define(["m/player/waveform/waveform.mixins"], function (mixins) {
  ...
  function WaveformAxis(view, viewName) {
  ...
  WaveformAxis.prototype.axisDrawFunction = function (canvas, currentFrameStartTime) {
    ...
    // Set text style
    if (this.viewName === "WaveformOverview") {
    ...
    ctx.fillStyle = "#ffff";
    ctx.textAlign = "left";
    ctx.textBaseline = "bottom"; //"hanging";
    ...
    for (;;) {
      ...
      var labelY     = /*0 + 1 + markerHeight;*/ this.view.height - 1 - markerHeight;
