...
define([
    ...
    that.stage.on("mouseover", function (event) {
      that.$container.bind('mousewheel', function(e, delta) {
        ...
        $.data(this, 'timer', setTimeout(function() {
          ...
          if (that.speakerLayer) {
            that.speakerLayer.setVisible(true);
            that.speakerLayer.draw();
          }
          if(that.keywordLayer) {
            that.keywordLayer.setVisible(true);
          }
          if(that.uiLayer) {
            that.uiLayer.setVisible(true);
          }
  ...
  WaveformZoomView.prototype.update = function() {
    ...
    if (that.speakerLayer) {
      that.speakerLayer.setVisible(false);
    }
    if(that.keywordLayer) {
      that.keywordLayer.setVisible(false);
    }
    if(that.uiLayer) {
      that.uiLayer.setVisible(false);
    }
